...
public static class TexButton
{
    ...
    public static readonly Texture2D
        ROMV_VampireSettingsIcon = ContentFinder<Texture2D>.Get("UI/VampSettings"); //Added 7-15-22
    ...
    public static readonly Texture2D ROMV_SunlightPolicyRestricted =
        ContentFinder<Texture2D>.Get("UI/Icons/SunlightPolicy/SunlightPolicyRestricted");

    public static readonly Texture2D ROMV_SunlightPolicyRelaxed =
        ContentFinder<Texture2D>.Get("UI/Icons/SunlightPolicy/SunlightPolicyRelaxed");

    public static readonly Texture2D ROMV_SunlightPolicyNoAI =
        ContentFinder<Texture2D>.Get("UI/Icons/SunlightPolicy/SunlightPolicyNoAI");
