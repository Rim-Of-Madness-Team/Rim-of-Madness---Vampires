    ...
    public static partial class GhoulUtility
    {
            ...
            Faction vampFaction = null, bool isRevenant = false)
        {
            ...
            PawnGenerationRequest request = new PawnGenerationRequest(
                PawnKindDefOf.SpaceRefugee, Faction.OfAncientsHostile, PawnGenerationContext.NonPlayer,
        ...
        {
            return pawn != null && pawn.GetComp<CompVampire>() is CompVampire v && v.IsGhoul;
        }
